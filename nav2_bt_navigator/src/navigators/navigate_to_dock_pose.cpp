...
#include <memory>
#include <limits>
#include "nav2_bt_navigator/navigators/navigate_to_dock_pose.hpp"

namespace nav2_bt_navigator
{

bool
NavigateToDockPoseNavigator::configure(
  ...
  std::shared_ptr<nav2_util::OdomSmoother> odom_smoother)
{
  ...
  goal_sub_ = node->create_subscription<geometry_msgs::msg::PoseStamped>(
    ...
    std::bind(&NavigateToDockPoseNavigator::onGoalPoseReceived, this, std::placeholders::_1));
  return true;
}

std::string
NavigateToDockPoseNavigator::getDefaultBTFilepath(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
...
bool
NavigateToDockPoseNavigator::cleanup()
{
  goal_sub_.reset();
  self_client_.reset();
  return true;
...
bool
NavigateToDockPoseNavigator::goalReceived(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavigateToDockPoseNavigator::goalCompleted(
...
void
NavigateToDockPoseNavigator::onLoop()
{
...
void
NavigateToDockPoseNavigator::onPreempt(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavigateToDockPoseNavigator::initializeGoalPose(ActionT::Goal::ConstSharedPtr goal)
{
  geometry_msgs::msg::PoseStamped current_pose;
  nav2_util::getCurrentPose(
    current_pose, *feedback_utils_.tf,
...
void
NavigateToDockPoseNavigator::onGoalPoseReceived(const geometry_msgs::msg::PoseStamped::SharedPtr pose)
{
  ActionT::Goal goal;
  goal.pose = *pose;
