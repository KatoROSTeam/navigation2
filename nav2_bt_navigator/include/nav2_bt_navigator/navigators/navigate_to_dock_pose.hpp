#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_DOCK_POSE_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_DOCK_POSE_HPP_
...
/**
 * @class NavigateToDockPoseNavigator
...
public:
  ...
  /**
   * @brief A constructor for NavigateToDockPoseNavigator
   */
  NavigateToDockPoseNavigator()
  : Navigator() {}
   ...
   */
  std::string getName() {return std::string("navigate_to_dock_pose");}
...
#endif  // NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_DOCK_POSE_HPP_
